  ...
  return (
    <div className="card p-6 animate-fade-in-delay-3">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-5">
        {indicators.map(ind => (
          <div key={ind.label} className="bg-slate-50 rounded-xl p-3 sm:p-4 border border-slate-100">
            <p className="text-slate-500 text-xs font-medium mb-1">{ind.label}</p>
            <p className={`font-display text-xl sm:text-2xl font-bold ${ind.color}`}>{ind.value}</p>
